...
const DealForm = ({ initialData, onSubmit, isProcessing, title, buttonText }) => {
    ...
    const [formData, setFormData] = useState(() => {
        if (initialData) {
            let pbType = 'FIXED';
            let pbVal = initialData.weight ? (initialData.pBrokerage / initialData.weight).toFixed(2) : 0;
            let sbType = 'FIXED';
            let sbVal = initialData.weight ? (initialData.sBrokerage / initialData.weight).toFixed(2) : 0;
